...
const AdminSidebar = () => {
  ...
  const links = [
    { to: '/admin', icon: Home, label: 'archives', end: true },
    { to: '/admin/users', icon: Users, label: 'directory' },
    { to: '/admin/analytics', icon: BarChart3, label: 'ledgers' },
    { to: '/admin/settings', icon: Settings, label: 'protocols' }
  ]
  ...
  return (
    <>
      ...
      <aside
        className='sidebar hidden md:flex flex-col fixed top-4 bottom-4 left-4 w-60 py-8 px-4 z-[100] border'
